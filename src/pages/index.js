      ...
      <Grid>
        ...
        <About hidden={!this.state.modal}>
          ...
          <p>
            ...
            You can feed them, but beware that they may multiply.
          </p>
          <p>
            ...
            To assist you, some stats on the distribution of their happiness are provided.
          </p>
          <h3> Gameplay </h3>
          <p>
          ...
          <p>
            ...
            Each mouse will try to eat at least once. If it cannot, its robustness will go down. <Blue> Failing to eat makes mice unhappy.</Blue>
            <p>
            </p>
            Some mice will try to eat twice.
            If they succeed, their robustness will go up. <Red>Eating a second time makes mice happy.</Red>
          </p>
          <p>
          ...
          <h3>Thanks</h3>
          <p> The mouse artwork for this game was uploaded to the Open Clip Art Library by  <a href="https://openclipart.org/user-detail/artbejo">artbejo</a>.</p>
          <p> This game uses Coiny and ZCool QingKe HuangYou from Google Fonts. </p>
          <p> This game was written in JavaScript using React and Gatsby. Code for the game available on <a href="https://github.com/dcshiller/happy_mice">Github</a>.</p>
          <br />
          <br />
          <em>For Oates</em>
          <br />
        ...
        <MenuBar>
          ...
          <MenuButton over={this.game.colony.livingMice().length === 0} onClick={this.showModal}> menu </MenuButton>
        </MenuBar>
        </SiteTitle>
